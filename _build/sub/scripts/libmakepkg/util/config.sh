...
source_makepkg_config() {
	...
	local MAKEPKG_CONF=${1:-${MAKEPKG_CONF:-/home/charlie/repos/pacman-5.2.1/pacman-5.2.1/pacman-5.2.1/_inst/etc/makepkg.conf}}
	...
	if [[ $MAKEPKG_CONF = "/home/charlie/repos/pacman-5.2.1/pacman-5.2.1/pacman-5.2.1/_inst/etc/makepkg.conf" ]]; then
